...
module lutdram
 ...
 localparam AWID = `log2(DDEP)     ; // write address width                                                                        
   ...
   xpm_memory_dpdistram #(
      ...
      .BYTE_WRITE_WIDTH_A(DWID),        // DECIMAL
      .CLOCKING_MODE("common_clock"), // String
      .MEMORY_INIT_FILE("none"),      // String
      .MEMORY_INIT_PARAM("0"),        // String
      .MEMORY_OPTIMIZATION("true"),   // String
      .MEMORY_SIZE(DWID*DDEP),             // DECIMAL
      .MESSAGE_CONTROL(0),            // DECIMAL
      .READ_DATA_WIDTH_A(DWID),         // DECIMAL
      .READ_DATA_WIDTH_B(DWID),         // DECIMAL
      ...
      .WRITE_DATA_WIDTH_A(DWID)         // DECIMAL
   )
   xpm_memory_dpdistram_inst (
      .douta(),   // READ_DATA_WIDTH_A-bit output: Data output for port A read operations.
      .doutb(),   // READ_DATA_WIDTH_B-bit output: Data output for port B read operations.
      .addra(),   // ADDR_WIDTH_A-bit input: Address for port A write and read operations.
      .addrb(),   // ADDR_WIDTH_B-bit input: Address for port B write and read operations.
      .clka(),     // 1-bit input: Clock signal for port A. Also clocks port B when parameter CLOCKING_MODE
                       // is "common_clock".
      ...
      .ena(),       // 1-bit input: Memory enable signal for port A. Must be high on clock cycles when read
                       // or write operations are initiated. Pipelined internally.

      .enb(),       // 1-bit input: Memory enable signal for port B. Must be high on clock cycles when read
                       // or write operations are initiated. Pipelined internally.

      .regcea(), // 1-bit input: Clock Enable for the last register stage on the output data path.
      .regceb(), // 1-bit input: Do not change from the provided value.
      .rsta(),     // 1-bit input: Reset signal for the final port A output register stage. Synchronously
                       // resets output port douta to the value specified by parameter READ_RESET_VALUE_A.

      .rstb(),     // 1-bit input: Reset signal for the final port B output register stage. Synchronously
                       // resets output port doutb to the value specified by parameter READ_RESET_VALUE_B.

      .wea()        // WRITE_DATA_WIDTH_A-bit input: Write enable vector for port A input data port dina. 1
...
endmodule   // End of xpm_memory_dpdistram_inst instantiation
