...
HD_PWD='/home/simone/ram_mixed/ram_mixed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log setram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source setram.tcl
